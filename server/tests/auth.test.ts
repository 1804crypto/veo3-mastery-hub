...
describe('Auth Routes: /api/auth', () => {
    ...
    it('should register a new user successfully (POST /register)', async () => {
        ...
        expect(res.body).toHaveProperty('message', 'Account created successfully! Welcome!');
    });
    ...
    it('should fail to register a user with an existing email (POST /register)', async () => {
        ...
        expect(res.body).toHaveProperty('message', 'An account with this email already exists. Please log in instead.');
    });
